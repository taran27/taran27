...
<img src="https://skillicons.dev/icons?i=ts,js,python,java,rust,go,react,nextjs,reactnative,expo,tailwind,nodejs,express,fastapi,graphql&perline=15" alt="languages-frameworks" />

#### Data, cloud & infrastructure

<img src="https://skillicons.dev/icons?i=postgres,mongodb,mysql,redis,prisma,aws,gcp,azure,docker,kubernetes,terraform,githubactions,vercel,nginx,bash&perline=15" alt="data-cloud-infra" />
